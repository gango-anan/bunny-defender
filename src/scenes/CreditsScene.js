...
export default class CreditsScene extends Phaser.Scene {
  ...
  displayCredits() {
    this.add.text(100, 380, 'CREDIT GOES TO', { fontSize: '32px', fill: '#fff' });
    this.add.text(20, 480, 'FREECODE CAMP', { fontSize: '24px', fill: '#fff' });
    this.add.text(20, 530, '(https://www.freecodecamp.org/)', { fontSize: '24px', fill: '#fff' });
    this.add.text(20, 600, 'YOUTUBE', { fontSize: '24px', fill: '#fff' });
    this.add.text(20, 630, '(https://www.youtube.com/)', { fontSize: '24px', fill: '#fff' });
    this.add.text(20, 700, 'PHASER TEAM', { fontSize: '24px', fill: '#fff' });
